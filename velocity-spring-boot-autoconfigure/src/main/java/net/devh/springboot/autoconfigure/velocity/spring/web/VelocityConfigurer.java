...
package net.devh.springboot.autoconfigure.velocity.spring.web;
...
public class VelocityConfigurer extends VelocityEngineFactory
     ...
     * custom by michael
     */
    private static final String SPRING_MACRO_LIBRARY = "net/devh/springboot/autoconfigure/velocity/spring/web/spring.vm";
