...
public class VelocityTemplateAvailabilityProvider
    ...
    public boolean isTemplateAvailable(String view, Environment environment,
        ...
        if (ClassUtils.isPresent("org.apache.velocity.app.VelocityEngine", classLoader)) {
            ...
            String prefix = environment.getProperty("spring.velocity.prefix",VelocityProperties.DEFAULT_PREFIX);
            String suffix = environment.getProperty("spring.velocity.suffix",VelocityProperties.DEFAULT_SUFFIX);
